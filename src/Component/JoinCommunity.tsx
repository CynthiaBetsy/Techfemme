...
const JoinCommunity = () => {
    return (
      <section
        id="join"
        className="py-16 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto bg-white rounded-xl shadow-md mt-12 flex flex-col md:flex-row items-center gap-12"
      >
        <div className="max-w-xl text-center md:text-left">
          ...
          <a
            href="https://join.slack.com/t/techfemmeacademy/shared_invite/xyz" 
            target="_blank"
